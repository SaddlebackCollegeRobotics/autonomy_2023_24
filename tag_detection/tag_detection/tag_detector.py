...
class Tag_Detector(Node):
    ...
    def __init__(self):
        ...
        self.detected_object_publisher_ = self.create_publisher(DetectedObject, '/object_detection/distance_est', qos_profile=qos_profile_sensor_data)
    ...
    def timer_callback(self):
        ...
        for tag in tags:
            self.detected_object_publisher_.publish(self.msg)
